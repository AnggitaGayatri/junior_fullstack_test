...
import com.example.anemoneapp.databinding.ActivityUpdateTeacher2Binding
import com.example.anemoneapp.utils.PreferenceManager

class UpdateTeacher : AppCompatActivity() {

    private lateinit var binding: ActivityUpdateTeacher2Binding // bisa reuse layout AddTeacher
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUpdateTeacher2Binding.inflate(layoutInflater)
